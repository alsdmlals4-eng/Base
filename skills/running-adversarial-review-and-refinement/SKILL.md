...
| 작업 | 책임 |
|---|---|
| 초안·기획·계획·제안의 실패 조건 공격 | 이 Skill |
| 비판의 유효성·우선순위 재판정 | 이 Skill |
| 승인된 finding만 최소 개선 | 이 Skill, 실제 파일 변경 권한은 작업 계약 |
| 수정 후 새 위험·기존 장점 회귀 검사 | 이 Skill |
| 실제 diff·정적·런타임·접근성·성능 통합 검증 | `reviewing-and-validating-project-changes` |
| 프로젝트 코어 판정·확정 | `identifying-project-core`, `establishing-project-core` |
| 전문 UI 시각 감사 | `auditing-and-refining-ui-art` |
