...
| `reviewing-and-validating-project-changes` | integrated-review | PASS | PASS | EXECUTABLE_EVIDENCE | TOOL: `tools/check_review_evidence.py`<br>TEST: `tests/test_consolidated_skill_references.py`<br>TEST: `tests/test_feature_spec_traceability_contract.py`<br>TEST: `tests/test_claim_and_intent_verification_contract.py`<br>TEST: `tests/test_claim_evidence_binding.py` |
