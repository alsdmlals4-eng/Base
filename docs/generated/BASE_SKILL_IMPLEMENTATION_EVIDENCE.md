...
| --- | --- | --- | --- | --- | --- |
| `managing-project-intake-and-work-contract` | planning-project-operations | PASS | PASS | EXECUTABLE_EVIDENCE | TEST: `tests/test_neutral_adversarial_feature_lifecycle.py`<br>TEST: `tests/test_consolidated_skill_references.py` |
...
| `managing-design-documents` | planning-documentation-publication | PASS | PASS | EXECUTABLE_EVIDENCE | TEST: `tests/test_consolidated_skill_references.py` |
...
| `auditing-and-refining-ui-art` | art-ui | PASS | PASS | EXECUTABLE_EVIDENCE | TEST: `tests/test_game_ux_ui_system.py` |
...
| `running-adversarial-review-and-refinement` | integrated-review | PASS | PASS | EXECUTABLE_EVIDENCE | TEST: `tests/test_neutral_adversarial_feature_lifecycle.py` |
