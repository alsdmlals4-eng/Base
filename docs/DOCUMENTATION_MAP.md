...
| 픽셀 아트 스타일 Reference | `docs/knowledge/game-development/PIXEL_ART_STYLE_SYSTEM.md`, `docs/knowledge/game-development/PIXEL_ART_VISUAL_REFERENCE_GALLERY.md` | 5축 픽셀 어휘·20 Preset·시각 예시·최소 3실질 대안·결정 직전 대안 탐색·장기 적합성·재검토를 제공; 프로젝트 Art Bible·제품 자산 권위는 소유하지 않음 |
...
| 픽셀 아트 후보 비교·프로젝트 스타일 결정 준비 | `docs/knowledge/game-development/PIXEL_ART_STYLE_SYSTEM.md`, `docs/knowledge/game-development/PIXEL_ART_VISUAL_REFERENCE_GALLERY.md` | `templates/planning/ART_DIRECTION_BRIEF.md`의 조건부 Pixel art candidate |
