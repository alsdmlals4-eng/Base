...
Base는 여러 프로젝트에 공통으로 필요한 AI 협업 원칙과 템플릿의 원본 저장소다. 프로젝트별 엔진 규칙, 제품 기획, 코드, 데이터, 테스트 결과는 각 프로젝트 저장소가 책임진다.

| 구분 | 파일 | 역할 |
|---|---|---|
| 공용 원본 | `AGENTS.md` | 최소 공용 AI 작업 원칙 |
| 공용 원본 | `docs/AI_SHARED_WORK_RULES.md` | 역할, 범위, 품질 원칙 |
| 공용 원본 | `docs/AI_WORKFLOW_RULES.md` | 공통 작업 순서와 Goal 작성 기준 |
| 공용 원본 | `docs/MVP_WORKFLOW_CHECKLIST.md` | MVP 시작/종료 체크리스트 |
