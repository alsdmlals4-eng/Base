...
Reconcile the approved design and plans with current Base main, run exact-head CI and independent review, merge, read back new main, and preserve the former PR #322 head as a backup branch.
