...
PROJECT_CONTRACT_PATH = ROOT / "tools/project_operating_contract.py"
...
class BaseV941CompatibilityReleaseTests(unittest.TestCase):
    ...
    def test_project_operating_contract_supports_v941_release_lock(self) -> None:
        text = PROJECT_CONTRACT_PATH.read_text(encoding="utf-8")
        self.assertIn('"9.4.1": Path("base-v9.4.1.lock.json")', text)
