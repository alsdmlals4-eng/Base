...
class SkillRoutingGovernanceTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.registry_path = (
            self.root / "[기획서]/00_프로젝트_허브/SKILL_REGISTRY.json"
        )
        self.skill_map = self.root / "[기획서]/00_프로젝트_허브/PROJECT_SKILL_MAP.md"
        ...
        self.skill_map.write_text("# Project Skill Map\n", encoding="utf-8")
    ...
    def _registry_data(self) -> dict:
        return {
            ...
            "discipline_entrypoints": {
                discipline: ["test-skill"] for discipline in DISCIPLINES
            },
        }
    ...
    def _write_config(self) -> None:
        config = {
            ...
            "skill_map": "[기획서]/00_프로젝트_허브/PROJECT_SKILL_MAP.md",
    ...
    def test_skill_change_requires_registry_map_and_learning_log_sync(self) -> None:
        self._git("init")
        ...
        self.assertIn("update skill map", result.stdout)
