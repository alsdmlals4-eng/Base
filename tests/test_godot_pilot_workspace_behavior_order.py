...
class GodotPilotWorkspaceBehaviorOrderTests(unittest.TestCase):
    ...
    def test_workspace_is_materialized_and_imported_before_behavior_checks(self) -> None:
        text = RUNNER.read_text(encoding="utf-8")
        ...
        self.assertLess(materialize, import_marker)
        self.assertLess(import_marker, behavior)
        self.assertLess(behavior, pilot)
