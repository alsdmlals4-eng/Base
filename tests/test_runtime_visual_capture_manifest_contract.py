...
class RuntimeVisualCaptureManifestContractTests(unittest.TestCase):
    ...
    def test_bcp047_is_approved_for_minimal_existing_owner_implementation(self) -> None:
        ...
        self.assertIn("- 상태: `APPROVED_FOR_IMPLEMENTATION`", proposal)
        self.assertIn("최소 구현 범위", proposal)
