...
Read `skills/PROJECT_BASE_ADAPTER.json`, then require a current generated `skills/PROJECT_SKILL_SNAPSHOT.json`. Refuse routing when the validator reports a stale pin, mismatched pin, hash drift, alias cycle, or generated-view drift.
