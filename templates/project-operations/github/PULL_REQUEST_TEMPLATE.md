...
- [ ] Intake·Context — Registry·관련 책임 원본·실제 파일·보호 범위 확인
- [ ] Deep Interview·User Confirmation — 대상 작업의 마지막 재진술 확인, 또는 허용된 예외 근거
...
- [ ] Documentation·Publication — Markdown/JSON·Registry·Skill·DOCX/PDF·Manifest 갱신
...
- [ ] 채택·비채택 요소 기록
- [ ] 콘셉트·실제 캡처 구분
- [ ] 관련 책임 원본의 승인 이미지 메타데이터와 사람용 문서 갱신
- [ ] 오디오 이벤트·믹싱·검증 상태 구분
...
- [ ] 변경 전후 보존 대조 작성
- [ ] 기존 본책은 승인된 Markdown/JSON 승계·발행·참조 검증 전 제거하지 않음
- [ ] 백업·보류·제거 후보 조건 기록
...
- [ ] 승인된 범위를 만족
- [ ] 제외·보호 범위를 침범하지 않음
- [ ] Markdown/JSON·Registry·Skill·발행본·실제 결과가 일치
...
- 다음 작업:
- 선행·재개 조건:
- 다음 작업자가 먼저 읽을 책임 원본·Registry·Skill:
- Base 환류 후보:
