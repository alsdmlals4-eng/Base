...
위 11개는 **권장 핵심 tab**이다. 기존 `11_세계관`, `12_핵심루프`, `15_조작_게임규칙`, `41_성장_경제`, `60_UX_UI_접근성`, `71_이미지기획_생성목록`, `80_데모_버티컬슬라이스_플레이테스트` 등은 자동 삭제하지 않는다. 실제 소비자·이력·사용자 편집을 감사한 뒤 각각 `10_경험`, `20_시스템_콘텐츠`, `30_세계_서사`, `40_표현`, `50_제작_검증`의 상세 보기로 연결하거나, 승인된 병합 계획에 따라 정리한다.
