...
# Reference-freshness regression: explicit strict IDs can be multi-alias, while
# human-facing compatibility names are allowed in strict execution entrypoints.
...
# Registry semantic change gets a real existing Required-CI consumer assertion.
