...
from loop_a2_local_executor.runtime import LocalA2Runtime, REVIEWED_TEST_IMAGE_REF
...
class ProofRunner:
    def __init__(self, *, image_id: str, receipt: dict[str, object]) -> None:
    ...
    def test_execute_reuses_preflight_verified_image_id_when_digest_alias_later_disappears(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            runtime = LocalA2Runtime(
                store=ProofStore(base, project, runtime_root),
                runner=runner,
