...
from expression_studio.imports import MAX_IMPORT_BYTES, discard_import_bytes, read_upload_limited, validate_imported_image
...
def test_discard_import_bytes_keeps_only_durable_metadata() -> None:
    imported = validate_imported_image(encoded_image("PNG"), declared_source="CHATGPT_INCLUDED", order=0)
