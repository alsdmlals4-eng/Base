"""Sprite-specific packet built on the shared Figma routing contract."""
...
class FigmaDeliveryPacket:
    """Instructions and local visual paths for a project GPT in the same workspace."""
    ...
    def public_view(self) -> dict[str, object]:
        return {
            ...
            "delivery_instruction": "Use this packet only in the matching project GPT workspace with the Figma connector; Base has not uploaded anything.",
        }
